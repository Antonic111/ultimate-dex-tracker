  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onLogin({
        ...
        nameColor1: loginData.user.nameColor1 || loginData.user.nameGradientColor1 || null,
        nameColor2: loginData.user.nameColor2 || loginData.user.nameGradientColor2 || null,
        ...
        isPremium: Boolean(loginData.user.isPremium),
        premiumMonths: loginData.user.premiumMonths || 0,
        premiumSince: loginData.user.premiumSince || null,
