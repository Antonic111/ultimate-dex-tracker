                ...
                {(collapsed === false || window.innerWidth >= 768) && (
                    <>
                        ...
                        <div className="relative flex items-center" style={{ height: '42px' }}>
                            ...
                            <SearchbarMultiSelectDropdown
                                id="searchbar-ball"
                                options={BALL_OPTIONS.filter(opt => opt.value !== "")}
                                selectedValues={filters.ball || []}
                        ...
                        <div className="relative flex items-center" style={{ height: '42px' }}>
                            ...
                            <SearchbarMultiSelectDropdown
                                id="searchbar-mark"
                                options={MARK_OPTIONS.filter(opt => opt.value !== "")}
                                selectedValues={filters.mark || []}
                        ...
                        <div className="relative flex items-center" style={{ height: '42px' }}>
                            ...
                            <SearchbarMultiSelectDropdown
                                id="searchbar-method"
                                options={getAllUniqueMethods().map(method => ({
                                    name: method,
                                    value: method
                                }))}
